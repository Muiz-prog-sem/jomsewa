                            ...
                            <td class="content-wrap" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;padding: 30px;border: 3px solid #67a8e4;border-radius: 7px; background-color: #fff;" valign="top">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <tbody>
                                        ...
                                        <h1>Your Booking has been Approved!</h1><hr>
                                        <p>Dear <b>{{ $booking->user->name }}</b>,</p>
                                        <p>We are pleased to inform you that your booking for the car model <b>{{ $booking->car->model }}</b> has been approved and ready for pickup from our premises.</p>
                                        </td>
                                    </tr>
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        ...
                                        <h3>Booking Details:</h3>
                                            <ul>
                                                <li>From: <b>{{ \Carbon\Carbon::parse($booking->book_from)->format('d/m/Y') }}</b></li>
                                                <li>To: <b>{{ \Carbon\Carbon::parse($booking->book_to)->format('d/m/Y') }}</b></li>
                                                <li>Duration: <b>{{ $booking->days }} days</b></li>
                                                <li>Total Payment: <b>RM{{ $booking->book_price }}</b></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block" itemprop="handler" itemscope="" itemtype="http://schema.org/HttpActionHandler" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                            <p>Please click the button below at your earliest convenience to retrieve your car.</p>
                                            <a href="https://maps.app.goo.gl/3s7hfTAYnotuk9Sc8" class="btn-primary" itemprop="url" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #f06292; margin: 0; border-color: #f06292; border-style: solid; border-width: 8px 16px;">Pickup Here</a>
                                        </td>
                                    </tr>
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                            If you have any questions or need further assistance, feel free to contact us at <b>03-199911</b>
